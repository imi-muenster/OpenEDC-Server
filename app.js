...
const routes = [
    ...
    new Endpoint(Endpoint.methods.GET, "/users", usersController.getUsers, userRights.PROJECTOPTIONS),
    new Endpoint(Endpoint.methods.GET, "/users/:oid", usersController.getUser, userRights.PROJECTOPTIONS),
    ...
    new Endpoint(Endpoint.methods.PUT, "/users/:oid", usersController.setUser, userRights.PROJECTOPTIONS),
    new Endpoint(Endpoint.methods.DELETE, "/users/:oid", usersController.deleteUser, userRights.PROJECTOPTIONS),
    new Endpoint(Endpoint.methods.GET, "/metadata/:fileName", metadataController.getMetadata),
    new Endpoint(Endpoint.methods.PUT, "/metadata/:fileName", metadataController.setMetadata, userRights.EDITMETADATA),
    new Endpoint(Endpoint.methods.DELETE, "/metadata/:fileName", metadataController.deleteMetadata, userRights.EDITMETADATA),
    new Endpoint(Endpoint.methods.GET, "/admindata/:fileName", admindataController.getAdmindata),
    new Endpoint(Endpoint.methods.PUT, "/admindata/:fileName", admindataController.setAdmindata, userRights.PROJECTOPTIONS),
    new Endpoint(Endpoint.methods.DELETE, "/admindata/:fileName", admindataController.deleteAdmindata, userRights.PROJECTOPTIONS),
    ...
    new Endpoint(Endpoint.methods.PUT, "/clinicaldata/:fileName", clinicaldataController.setClinicaldata, userRights.ADDSUBJECTDATA),
    new Endpoint(Endpoint.methods.DELETE, "/clinicaldata/:fileName", clinicaldataController.deleteClinicaldata, userRights.ADDSUBJECTDATA),
    new Endpoint(Endpoint.methods.GET, "/json/:fileName", jsonController.getJSON),
    new Endpoint(Endpoint.methods.PUT, "/json/:fileName", jsonController.setJSON, userRights.PROJECTOPTIONS),
    new Endpoint(Endpoint.methods.DELETE, "/json/:fileName", jsonController.deleteJSON, userRights.PROJECTOPTIONS)
];
